...
public:
   ...
   ScipParaLoadCoordinator(
         ...
         UG::ParaInitiator *inParaInitiator,       ///< ParaInitiator for initialization of solving algorithm
         bool *inRacingSolversExist,               ///< indicate racing solver exits or not
         UG::ParaTimer *inParaTimer,               ///< ParaTimer used
         UG::ParaDeterministicTimer *inDetTimer    ///< DeterministicTimer used
         ) : ScipParaLoadCoordinator(
#ifdef UG_WITH_UGS
         inComUgs,          ///< communicator used for UGS
#endif
         N_SCIP_TAGS,
         inComm, inParaParamSet, inParaInitiator, inRacingSolversExist, inParaTimer, inDetTimer
               )
   {
   }
