...
public:
   ...
   // tell compiler that we want the lockApp(char const *f,int l)
   // from the upper class, and overwrite lockApp() only
   using ParaComm::lockApp;
   ///
