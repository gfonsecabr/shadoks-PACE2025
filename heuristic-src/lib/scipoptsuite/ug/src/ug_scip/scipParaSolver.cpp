...
ScipParaSolver::ScipParaSolver(
      ...
      ) : BbParaSolver(argc, argv, inNhanders, comm, inParaParamSet, inParaInstance, inDetTimer),
      messagehdlr(0),
      logfile(0),
      originalParamSet(0),
      conflictConsList(0),
...
#if( !defined(UG_QUBO) && !defined(UG_SMOOTHIE) )
...
#ifndef SCIP_EVENTTYPE_COMM
   // std::cout << "#### SCIP_EVENTTYPE_COMM is not defined!" << std::endl;
      ...
      copyIncreasedVariables(false)
{
   ...
   */ 
   ...
   // std::cout << "##################### paraInstance is deleted ####################" << std::endl;
