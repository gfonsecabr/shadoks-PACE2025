...
public:
    ...
    void build_instance(int numVars, int numClauses, unsigned long long topClauseweight, clauselit **nuwls_clause, int *nuwls_clause_lit_count, long long *nuwls_clause_weight);
